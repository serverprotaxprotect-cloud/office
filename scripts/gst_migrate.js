...
const statements = [
  ...
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS legal_name VARCHAR(255)`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS trade_name VARCHAR(255)`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS taxpayer_type VARCHAR(120)`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS gst_registration_date DATE`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS gst_cancellation_date DATE`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS gst_portal_status VARCHAR(80)`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS gst_constitution VARCHAR(160)`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS gst_last_verified_at TIMESTAMPTZ`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS gst_verification_source VARCHAR(80)`,
  `ALTER TABLE gst_clients ADD COLUMN IF NOT EXISTS gst_verification_raw JSONB`,
  ...
  `ALTER TABLE gst_filing_records ADD COLUMN IF NOT EXISTS portal_filing_status VARCHAR(80)`,
  `ALTER TABLE gst_filing_records ADD COLUMN IF NOT EXISTS portal_filed_date DATE`,
  `ALTER TABLE gst_filing_records ADD COLUMN IF NOT EXISTS portal_arn VARCHAR(120)`,
  `ALTER TABLE gst_filing_records ADD COLUMN IF NOT EXISTS portal_last_synced_at TIMESTAMPTZ`,
